...
namespace ServiceStack.Auth
{
    ...
    /// </summary>
    //public class MyJwtAuthProvider2 : JwtAuthProviderReader, IAuthResponseFilter
    //{
    //    /// <summary>
    ...
    //    public MyJwtAuthProvider2() { }

    //    public MyJwtAuthProvider2(IAppSettings appSettings) : base(appSettings) { }
    ...
    //        try
    //        {
    //            jwtPayload = jwtAuthProvider.GetVerifiedJwtPayload(base.Request, request.RefreshToken.Split('.'));
    //        }
    ...
    //        //var session = SessionFeature.GetOrCreateSession<CustomUserSession>();
    //        //var session = userAuth.ConvertTo<CustomUserSession>();
