...
namespace ExpressBase.ServiceStack.Auth0
{
    public class EbRedisAuthRepository: RedisAuthRepository
    {
        ...
        new public IUserAuth UpdateUserAuth(IUserAuth existingUser, IUserAuth newUser)
        {
            // newUser.ValidateNewUser(password);
        ...
        //public EbRedisAuthRepository(IRedisClientsManager factory)
        //    : this(new RedisClientManagerFacade(factory)) { }

        //public EbRedisAuthRepository(IRedisClientManagerFacade factory) { this.factory = factory; }
